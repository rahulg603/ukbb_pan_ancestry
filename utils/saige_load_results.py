...
def main(args):
    ...
    cases, controls = custom_get_cases_and_controls_from_log(args.saige_run_log_format)
    ...
    custom_load_variant_data(args.input_dir, pheno_key_dict, args.ukb_vep_ht_path, extension, cases, controls, heritability, saige_version, inv_normalized,
